...
public class Helper {
	 ...
	 */
	public static long hashSocketAddress (InetSocketAddress addr) throws RemoteException, NoSuchAlgorithmException {
	 ...
	 * @return 32-bit identifier in long type
	 */
	public static long hashString (String s) throws RemoteException, NoSuchAlgorithmException {
	...
	private static long hashHashCode (String key) throws RemoteException, NoSuchAlgorithmException {
	 ...
	 * @return
	 */
	public static String hexIdAndPosition (InetSocketAddress addr) throws RemoteException, NoSuchAlgorithmException {
